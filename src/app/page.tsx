        ...
        <div className={styles.footer}>
          <div className={styles.footerMiddle}>
            <div className={styles.left}>
              ...
              {/*    <svg height="22" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="22"*/}
              {/*         data-view-component="true" fill='#444444'>*/}
              {/*      <path*/}
              ...
              {/*}}>*/}
              {/*  <span className={styles.icon}>*/}
              {/*    <svg aria-hidden="true" height="22" viewBox="0 0 16 16" version="1.1" width="22"*/}
              {/*         data-view-component="true" fill='#444444'>*/}
              {/*      <path*/}
              ...
              {/*</div>*/}
              <div className={styles.line} onClick={e => {
                window.open('https://github.com/RhineAI-Lab/suc-arena-frontend')
              }}>
                <span className={styles.icon}>
                  <svg height="22" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="22"
                       data-view-component="true" fill='#444444'>
                ...
                <span>RhineAI-Lab/SucArenaFrontend</span>
              </div>
              <div className={styles.line} onClick={e => {
                window.open('https://github.com/RhineAI-Lab/suc-arena-frontend')
              }}>
