          ...
          <div className={styles.footerMiddle}>
            <div className={styles.left}>
              <div className={styles.line} onClick={e => {
                ...
                AppTools.message('Anonymous mode does not support redirection.', 'warning')
              }}>
                ...
                <span>XxxxXxxxx/XxxxxXxxxxXxxx</span>
              </div>
              <div className={styles.line} onClick={e => {
                // window.open('https://github.com/MikeGu721/SuccessionArena')
                AppTools.message('Anonymous mode does not support redirection.', 'warning')
              ...
              <div className={styles.line} onClick={e => {
                ...
                <span style={{color: '#000000'}}>XX.XXXXXXX.COM</span>
              </div>
            </div>
            <div className={styles.space}></div>
            <div className={styles.right}>
              <div className={styles.author}>
                ...
                <span>Xxxxxxx Xxxxxxx Group</span>
                <span>@ Xxxxxxxxxxx Laboratory</span>
                <span>@ Xxxxx University</span>
              </div>
            </div>
          </div>
          {/*<div className={styles.footerMiddle}>*/}
